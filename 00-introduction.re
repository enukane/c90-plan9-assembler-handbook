...
ご存じの方もいるでしょう.
その例に漏れず, 同じアセンブラといえど Plan 9 のアセンブラも gas や NASM と
異なる文化を持っています.

Plan 9 のマシン依存部や pcb (PC bootstrap program)と呼ばれる
古式ゆかしきx86向けブートローダ, 9front に最近入った UEFI 対応のローダなど
様々な低レイヤの面白い箇所にこのアセンブラは登場します.

本書ではいわゆる 32bit i386 向けの 8a, 64bit amd64 向けの 6a をメインに
このアセンブラの独特の文法や作法などを紹介します.
